...
class DeviceMetadataService {
  ...
  String _base64HashArmored(String input) {
  ...
  Future<void> init() async {
    ...
    if (Platform.isAndroid) {
      ...
      deviceId = _base64HashArmored(androidInfo.fingerprint);
    } else if (Platform.isIOS) {
      final IosDeviceInfo iosInfo = await deviceInfo.iosInfo;
      deviceId = _base64HashArmored(
          iosInfo.identifierForVendor ?? _generateRandomString(20));
    }
